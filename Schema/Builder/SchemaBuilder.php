<?php
namespace BD\EzPlatformGraphQLBundle\Schema\Builder;

use BD\EzPlatformGraphQLBundle\Schema\Builder as SchemaBuilderInterface;
...
class SchemaBuilder implements SchemaBuilderInterface
{
    ...
    public function addType(Input\Type $typeInput)
    {
        ...
        if (!empty($typeInput->inherits)) {
            $type['inherits'] = [$typeInput->inherits];
        }
        if (!empty($typeInput->interfaces)) {
            $type['config']['interfaces'] = [$typeInput->interfaces];
        }
